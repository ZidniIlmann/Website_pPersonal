<?php 
    ...
    $haga_jual = $_POST['harga_jual'];
    $gampar_produk = $_FILES['gambar_produk']['name'];

    if($gambar_produk != "") {
        $ekstensi_diperbolehkan = array('png', 'jpg');
        $x = explode('.', $gambar_produk);
        $ekstensi = strolower(end($x));
        ...
        if(in_array($ekstensi, $ekstensi_diperbolehkan) === true){
            ...
            $query = "INSERT INTO produk (nama_produk, deskripsi, harga_beli,harga_jual, gambar_produk) VALUES ('$nama_produk', '$deskripsi', '$harga_beli', '$haga_jual', '$nama_gambar_baru')";
