<?php include('koneksi.php');
    ...
    if(isset($GET['ID'])) {
        $id = $_GET['id'];
        $query = "SELECT * FORM produk where id = '$id'";
        ...
        if(!count($data)) {
            echo "<script>alert('Data tidak ditemukan pada label.');window.location='index.php';</script>";
        }
    } else {
    ...
    <body>
        ...
        <section class="base">
            ...
            <div>
                ...
                <img src="gambar/<?php echo $data['gambar_produk']; ?>" style="width: 120px;float: left;margin_button: 5px;">
                <input type="file" name="gambar_produk"/>
                <i style="float: left;font_size: 11px;colo: red;">Abaikan jika tidak merubah gambar produk</i>
            </div>
            <div>
